...
/obj/item/rogueweapon/example/sumquoderis
	...
	A staggeringly large executioner's sword, seemingly formed from one single slab of metal. \
	The grip of the blade is wreathed in blood-red thorns sprouting from hollows within the crossguard, crimson ichor dripping from the vines. \
	A surprisingly heavy pommel allows for deceptively quick strikes, but the grotesque weight of the blade \
	is capable of cleaving bodies in twain. The weapon, though well-crafted, is entirely without adornment. \
	When you fall, leave behind a beautiful corpse. Do not die of decay."
	icon = 'icons/obj/items/donor_weapons_64.dmi'
